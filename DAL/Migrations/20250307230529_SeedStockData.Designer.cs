...
namespace InventoryManagmentSystem.DAL.Migrations
{
    ...
    [Migration("20250307230529_SeedStockData")]
            ...
            modelBuilder.Entity("DAL.Models.Stock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LastUpdate = new DateTime(2025, 3, 8, 1, 5, 29, 20, DateTimeKind.Local).AddTicks(8312),
                            ProductId = 1,
                            Quantity = 50,
                            Type = "Supply"
                        },
                        new
                        {
                            LastUpdate = new DateTime(2025, 3, 8, 1, 5, 29, 23, DateTimeKind.Local).AddTicks(3377),
                            ProductId = 2,
                            Quantity = 30,
                            Type = "Supply"
                        },
                        new
                        {
                            LastUpdate = new DateTime(2025, 3, 8, 1, 5, 29, 23, DateTimeKind.Local).AddTicks(3401),
                            ProductId = 3,
                            Quantity = 20,
                            Type = "Supply"
                        },
                        new
                        {
                            LastUpdate = new DateTime(2025, 3, 8, 1, 5, 29, 23, DateTimeKind.Local).AddTicks(3404),
                            ProductId = 4,
                            Quantity = 20,
                            Type = "Supply"
                        });
