    ...
    public partial class FixDecimalPrecision : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Stocks",
                keyColumns: new[] { "LastUpdate", "ProductId" },
                keyValues: new object[] { new DateTime(2024, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 3 });

            migrationBuilder.DeleteData(
                table: "Stocks",
                keyColumns: new[] { "LastUpdate", "ProductId" },
                keyValues: new object[] { new DateTime(2024, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 4 });

            migrationBuilder.DeleteData(
                table: "Stocks",
                keyColumns: new[] { "LastUpdate", "ProductId" },
                keyValues: new object[] { new DateTime(2024, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });

            migrationBuilder.DeleteData(
                table: "Stocks",
                keyColumns: new[] { "LastUpdate", "ProductId" },
                keyValues: new object[] { new DateTime(2025, 3, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 });
